...
//
//@RestController
//@RequestMapping("${endpoint.order-request-detail.base}")
//@RequiredArgsConstructor
//@Slf4j
//public class OrderRequestDetailController {
...
//
//    @GetMapping(value = "${endpoint.order-request-detail.get-all}", produces = MediaType.APPLICATION_JSON_VALUE)
...
//    }
//
//    @GetMapping(value = "${endpoint.order-request-detail.get-by-id}", produces = MediaType.APPLICATION_JSON_VALUE)
...
//    }
//
//    @PutMapping( value = "${endpoint.order-request-detail.update}", produces = MediaType.APPLICATION_JSON_VALUE)
...
//    }
//
//    @DeleteMapping(value = "${endpoint.order-request-detail.delete}", produces = MediaType.APPLICATION_JSON_VALUE)
